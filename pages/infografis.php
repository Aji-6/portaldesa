<section class="lb-wilayah">
    <h1>LUAS WILAYAH & BATAS WILAYAH</h1>
    <div class="content">
        <p>
            Desa Porangparing Desa Porangparing, Sukolilo, Pati, Jawa Tengah Desa
            Porangparing terletak di Kecamatan Sukolilo, Kabupaten Pati, Provinsi
            Jawa Tengah.
        </p>
        <ul>
            <p>Luas Wilayah : <span>808,40 hektar</span></p>
            <li>Batas Utara : <span>Desa Kedungwinong</span></li>
            <li>Batas Timur : <span>Desa Gemblung, Jati Pohon</span></li>
            <li>Batas Selatan : <span>Jati Pohon, Desa Tegal Sumur</span></li>
            <li>Batas Barat : <span>Desa Kuwawur</span></li>
        </ul>
    </div>
</section>
<!-- diagram -->
